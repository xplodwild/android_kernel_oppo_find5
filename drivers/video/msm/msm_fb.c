					...
					enum led_brightness value)
{
	...
	int bl_lvl;
	//static int bl_buf[BK_LEVEL] = {0,74,87,95,101,105,109,112,115,117,119,121,123,124,126,127};

/* OPPO 2012-12-01 wangjc Modify begin for reason */
...
#endif
/* OPPO 2012-12-01 wangjc Modify end */
	if (!bl_lvl && value)
		bl_lvl = 1;
