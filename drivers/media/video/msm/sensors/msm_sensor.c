		...
		case CFG_SET_EXP_GAIN:
			...
			rc =
				...
				sensor_write_exp_gain(
					...
					cdata.cfg.exp_gain.line,/*OPPO HDR*/
					cdata.cfg.exp_gain.luma_avg,/*OPPO HDR*/
					cdata.cfg.exp_gain.fgain);/*OPPO HDR*/
